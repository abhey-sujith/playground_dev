    ...
    <>
      ...
      >
       ...
       {x1axis.map((value, index) => {
        ...
        <Vehicle ref={vehicle} position={[0, 2, 0]} rotation={[0, -Math.PI / 4, 0]} angularVelocity={[0, 0.5, 0]} wheelRadius={0.3} >
          <object3D ref={cameraDummy} name="CameraDummy" position={[5, 2, 5]}  />
            </Vehicle>
